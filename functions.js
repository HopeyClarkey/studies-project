 ...
 * FUNCTIONS:
 * 
 * 0: Functions are a fundemental building block of Javascript. A function in javascript is 
 * similar to a procedure- a set of statements that performs a task or calculates a value,
 * but for a procedure to qualify as a function, it should take some input and return an
 * output where there is some obvious relationship between the input and the output. To
...
*/
 /* 
 *  7) closures: Functions form closures areound the data they house. If an object returned 
